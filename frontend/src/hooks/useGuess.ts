...
export default function useGuess() {
    ...
    const [isGuessLoading, setIsLoading] = useState(false); // Users cannot guess again until the promise is fulfilled and the guess registers.
    ...
    return { guessItem, isGuessLoading, error } // Returning the error for UI display later.
}